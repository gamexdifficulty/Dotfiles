...
libcamera-vid -t 0 --framerate 24 --width 1920 --height 1080 --inline --buffer-count 4 --denoise cdn_off -o - | ffmpeg -re -i - -c:v libx264 -preset ultrafast -tune zerolatency -bufsize 2M -maxrate 2M -f rtsp -rtsp_transport tcp rtsp://127.0.0.1:8554/live/stream' >> start_cam.sh
